...
public class NoteServiceImpl implements NoteService {
	...
	public boolean createNote(Note note) {
		...
		Optional<NoteUser> findById = noteRepository.findById(note.getNoteCreatedBy());
		NoteUser noteUser = findById.orElse(new NoteUser());
		...
		if (findById.isPresent()) {
			noteUser = noteRepository.save(noteUser);
		} else {
			noteUser = noteRepository.insert(noteUser);
		}
	...
	public List<Note> getAllNoteByUserId(String userId) {
		...
		NoteUser noteUser = noteRepository.findById(userId).orElse(new NoteUser());
