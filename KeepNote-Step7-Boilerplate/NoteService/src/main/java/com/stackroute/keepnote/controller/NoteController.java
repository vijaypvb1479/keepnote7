...
public class NoteController {
	...
	@ApiOperation(value = "Delete Note by UserId")
	 ...
	 */
	@ApiOperation(value = "Get Notes by UserID")
	...
	public ResponseEntity<?> getAllNoteByUserId(@PathVariable("userId") String userId) {
		...
		HttpHeaders headers = new HttpHeaders();
		List<Note> allNoteByUserId = noteService.getAllNoteByUserId(userId);
		log.info("getAllNoteByUserId : ENDED");
		return ResponseEntity.ok()
		        .headers(headers)
		        .body(allNoteByUserId);
	 ...
	 * 
	 */
	@ApiOperation(value = "Get Notes by Userid and Note Id")
